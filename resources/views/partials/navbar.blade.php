  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item {{ request()->routeIs('post.create') ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('post.create') }}">Create Article</a>
      </li>
    </ul>
    <!-- End Menu -->
    <!-- Begin Search -->
    <form class="form-inline my-2 my-lg-0" action="{{ route('post.index') }}" method="get">
      <input class="form-control mr-sm-2" type="text" placeholder="Search Article" name="q">
